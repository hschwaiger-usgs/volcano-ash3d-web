...
!     Also expects contour files
      ...
      character(len=24) :: cfile1, cfile2, cfile3, cfile4
      character(len=22) :: progname
      character(len=26) :: outfile

      !set constants
      pi             = 3.14159_8
      cfile1 = 'contourfile_0.01_0_i.xyz'
      cfile2 = 'contourfile_0.01_0.xyz'
      cfile3 = 'contourfile_0.01_1_i.xyz'
      cfile4 = 'contourfile_0.01_2_i.xyz'
      progname = 'legend_positions_dp_mm'
