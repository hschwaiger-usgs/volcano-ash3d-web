...
!     be used for a standard run.
      ...
      integer          :: i,iday,imonth,iyear,iwind,iwindformat,nargs,nWindFiles
      integer          :: status
...
1005     format('Wind_nc/gfs/latest/latest.f')
      ...
      width   = 1.3_8*height/cos(3.14_8*v_lat/180._8)
...
5     format( &
      ...
      '2        0.06118	800     0.65',/, &
      '1        0.07098 1040    0.65',/, &
      '0.5      0.22701 1280    0.65',/, &
      '0.25     0.21868 1520    0.65',/, &
      '0.1768   0.05362 1640    0.65',/, &
      '0.125    0.04039 1760    0.65',/, &
      '0.088    0.02814 1880    0.65',/, &
