...
!     TEST READ COMMAND LINE ARGUMENTS
      ...
      write(6,*) 'opening DepositFile_____final.dat'
      open(unit=11,file='DepositFile_____final.dat',status='old',err=1900)
...
1900  write(6,*) 'error: DepositFile_____final.dat files do not exist.'
      write(6,*) 'Program stopped'
      stop 1
