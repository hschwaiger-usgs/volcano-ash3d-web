...
!     GFSVolc_to_gif_ac.sh
      ...
      legend1_height  = 110.0
      legend2_width   = 100.0              !width of legend_dep_nws.gif
      legend2_height  = 75.0
      ...
      close(10)
      if (latmax.gt.85.0) latmax=85.0
      if (latmin.lt.-85.0) latmin=-85.0
...
!***************************************************************************************************************
      ...
      legend1x_UR_alt = lonmin+0.98*dlon
      yUR             = ytop_map+0.10*map_height
...
!*******************************************************************************************************
      ...
      if ((vclon.lt.legend1x_LR).and.(vclat.gt.legend1y_LR)) then
       ...
       else if ((vclon.lt.legend2x_UR).and.(vclat.lt.legend2y_UR)) then
