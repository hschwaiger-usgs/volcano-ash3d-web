...
!       echo "$LLLON $URLON $LLLAT $URLAT $VCLON $VCLAT" > map_range.txt
      ...
      legend2_width   = 100.0_8              !width of legend_dep_nws.gif (although different legends are used.)
...
3     format('    Caption placement:   lon       lat     x     y',/, &
             ...
             '    writing to legend_positions_ac.txt')
...
4     format('legend1x_UL=',f10.3,       '    legend1y_UL=',f10.3,/, &
      ...
      write(6,*)"legend_placer_ac ended normally."
