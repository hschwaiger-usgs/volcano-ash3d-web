...
# Plot variable
  ...
  # Wrote out legend_positions_dp.txt
...
convert -append -background white deposit_thickness_inches.gif ${CAVEAT} deposit_thickness_inches.gif
...
echo "${SLAB}  "
echo "${SLAB} ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++"
echo "${SLAB} finished GFSVolc_to_gif_dp.sh $varID $var"
echo `date`
echo "${SLAB} ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++"

echo "${SLAB} exiting GFSVolc_to_gif_dp.sh with status $rc"
exit $rc
