...
command -v "${ASH3DSCRIPTDIR}/GFSVolc_to_gif_tvar.sh"     > /dev/null 2>&1 ||  { echo >&2 "${SLAB} GFSVolc_to_gif_tvar.sh not found. Exiting"; exit 1;}
...
#echo "${SLAB} Creating soft links to topo file (Not needed for cloud runs)"
#rm -f GEBCO_2023.nc
